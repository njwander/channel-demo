...
1. 客户报备成功后需要在保护期内(500人以下的可以保护7天，500人以上的可以保护15天)进行有效的跟
2. 如果客户在保护期内，销售有宣讲类型的跟进记录，则记为有效报备，否则记为无效报备。
3. 预留一个有效报备的申述入口，可以通过申请，提交资料，审批后修改为有效报备。
   > 客户报备在临近保护期的前3天，上午9点发送通知给渠道负责人
...
5. **后续状态流转**：
   - **已转化**：OMS 同步该客户产生了已签约的订单，状态流转为 **已转化**。
...
2. **渠道负责人核对**
   ...
   - **核对确认**：数据无误（通常已与外部渠道接口人确认一致），在系统中点击“确认结算”。
